/**
 * Checkout and payment handling script
 * Manages the checkout form submission and payment processing
 */
            ...
            try {
                ...
                if (!response.ok) {
                    ...
                    if (response.status === 400) {
                        ...
                        if (result.error && result.error.includes('already being processed')) {
                            throw new Error('A payment for this order is already in progress. Please check your order history.');
                        }
                    }
                ...
                // Update error display with more user-friendly messages
                const errorMessage = error.message.includes('already being processed')
                    ? 'This order already has a pending payment. Please check your order history or try again with a new cart.'
                    : error.message;
